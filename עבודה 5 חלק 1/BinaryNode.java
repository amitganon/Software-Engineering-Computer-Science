...
public class BinaryNode<T> {
    ...
    public String toString() {//print the tree, order: "inorder"
        // task4
    	return toString("",0);//calling private toString
    }
    
    private String toString(String str,int high) {//making string of BinaryTree, order="inorder"
    	String strLeft="";
    	String strRight="";
    	if(left!=null)//calling left node
    		strLeft=left.toString("",high+1);
    	str=multyplayString(" ",high*2) + data+"\n"; // adding data to the string
    	if(right!=null)//calling right node
    		strRight=right.toString("",high+1);
    	return strLeft+str+strRight;
    }
    
    private String multyplayString(String str,int multy) {//making string multiply by number
    	String ans="";
